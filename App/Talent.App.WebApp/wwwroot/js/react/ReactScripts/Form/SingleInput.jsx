  ...
  render() {
    return (
      <div className="field">
        ...
        />
        {this.props.isError ?  TalentUtil.notification.show(this.props.errorMessage, 'error', null, null) : null}
      </div>
    )
  }
}
...
export class CharactersRemaining extends React.Component {
  render() {
    const characters = this.props.characters ? this.props.characters.length : 0
