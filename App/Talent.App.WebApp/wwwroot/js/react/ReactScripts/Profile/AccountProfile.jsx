...
export default class AccountProfile extends React.Component {
  ...
  init() {
    const loaderData = this.state.loaderData
  ...
  async loadData() {
    const link = 'http://localhost:60290/profile/profile/getTalentProfile';
  ...
  updateAndSaveData(newValues) {
    const newProfile = Object.assign({}, this.state.profileData, newValues)
    console.log("before save", newProfile);
  ...
  async saveProfile() {
    const link = 'http://localhost:60290/profile/profile/updateTalentProfile'
  //  var res = await xhr.post(link, this.state.profileData);  
    const cookies = Cookies.get('talentAuthToken')
    $.ajax({
      url: link,
      //headers: {
            ...
            <div className="ui container">
              <div className="profile">                
                  <div className="ui grid">
                    ...
                    <FormItemWrapper
                      title="Description"
                      tooltip="Add a short summary and a description to your profile"
                    >
                    <Description
                    ...
                    >
                      <VideoUpload
                        ...
                        updateProfileData={this.updateWithoutSave}
                        saveVideo="http://localhost:60290/profile/profile/addTalentProfileImages"
                      />
                    </FormItemWrapper>
                    <FormItemWrapper
                      title="CV"
