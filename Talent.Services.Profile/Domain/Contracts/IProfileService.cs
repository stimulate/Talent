...
namespace Talent.Services.Profile.Domain.Contracts
{
    public interface IProfileService
    {
        ...
        Task<bool> AddNewExperience(AddExperienceViewModel experience);
        Task<bool> AddNewEducation(AddEducationViewModel education);
        Task<bool> AddNewCertification(AddCertificationViewModel certification);
        ...
        Task<IEnumerable<TalentSuggestionViewModel>> GetATalentList();
        Task<IEnumerable<TalentMatchingEmployerViewModel>> GetEmployerList();
